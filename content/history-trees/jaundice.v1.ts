...
/**
 * JAUNDICE — v1.0.0. CLINICAL CONTENT: REVIEWED.
...
export const jaundiceV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "altered_sensorium", "Drowsiness / confusion / sleep reversal", "Any drowsiness, confusion, irrelevant talk, or day-night sleep reversal (encephalopathy)?", ["drowsy", "drowsiness", "confused", "confusion", "altered sensorium", "irrelevant talk", "sleep reversal", "irritable", "disoriented", "unconscious", "behaviour change"], { teach: "Drowsiness, sleep reversal or confusion with jaundice is the definition of hepatic encephalopathy and marks acute liver failure or decompensation." }),
    yn("red_flag", "bleeding_manifestations", "Bleeding manifestations", "Any bleeding from any site?", ["bleeding", "haematemesis", "hematemesis", "malena", "melena", "epistaxis", "gum bleeding", "petechiae"], { teach: "Bleeding with jaundice means the liver is no longer making clotting factors, or the platelets are low from a large spleen; both are urgent." }),
    yn("red_flag", "urine_output", "Reduced urine output", "Has the urine output reduced?", ["urine output", "decreased urine", "reduced urine", "less urine", "oliguria", "not passing urine"], { teach: "Reduced urine output with jaundice raises hepatorenal syndrome, leptospirosis and severe malaria." }),
    yn("red_flag", "fever_with_rigors_pain", "Fever with rigors and right upper pain", "Is there fever with rigors together with right upper abdominal pain (cholangitis)?", ["rigors", "chills", "fever with", "right hypochondrium", "right upper", "charcot"], { teach: "Fever with rigors and right upper abdominal pain alongside jaundice is the triad of cholangitis, which needs the bile duct drained rather than watched." }),
    yn("red_flag", "alcohol", "Alcohol", "How much alcohol, for how long, and when was the last drink?", ["alcohol", "drinks", "drinker", "alcoholic", "daily drinking", "binge", "last drink", "country liquor", "desi"], { teach: "The amount and duration of alcohol, and when the last drink was, separate alcoholic hepatitis and withdrawal from the other causes." }),
    yn("red_flag", "hepatotoxic_drugs", "Hepatotoxic drugs / ATT / herbal", "Any anti-tubercular drugs, paracetamol excess, herbal or ayurvedic preparations, or other new drugs recently?", ["att", "akt", "anti tubercular", "isoniazid", "rifampicin", "paracetamol", "herbal", "ayurvedic", "desi dawai", "bhasma", "new medicine", "started on", "drug", "supplements", "anabolic"], { teach: "Anti-tuberculosis drugs, paracetamol, herbal and traditional medicines, and many others cause jaundice; the list is only found by asking about every tablet taken." }),
    PREGNANCY,
    IMMUNOCOMPROMISE,
    // Exposures
