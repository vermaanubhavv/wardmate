...
/**
 * COUGH / HAEMOPTYSIS — v1.0.0. CLINICAL CONTENT: PENDING CLINICIAN REVIEW.
...
export const coughV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "massive_haemoptysis", "Large-volume haemoptysis", "Has there been a large volume of blood (cupfuls) or is bleeding continuing?", ["cupful", "cupfuls", "large amount", "massive", "profuse", "continuous bleeding", "more than", "ml"]),
    yn("red_flag", "cough_over_two_weeks", "Cough more than two weeks", "Has the cough lasted more than two weeks?", ["two weeks", "2 weeks", "more than 2 weeks", "three weeks", "3 weeks", "month", "months", "weeks"]),
    yn("red_flag", "rest_dyspnoea", "Breathless at rest", "Is the patient breathless at rest or unable to complete sentences?", ["at rest", "unable to speak", "cannot complete sentences", "gasping", "severe breathlessness"]),
    yn("red_flag", "altered_sensorium", "Drowsiness / confusion", "Any drowsiness or confusion?", ["drowsy", "drowsiness", "confused", "confusion", "altered sensorium", "disoriented"]),
    yn("red_flag", "tb_contact", "TB contact / past TB / treatment", "Any contact with a TB patient, past TB, or previous anti-tubercular treatment (completed or defaulted)?", ["tb", "tuberculosis", "koch", "att", "akt", "dots", "tb contact", "past tb", "defaulted", "incomplete treatment", "mdr"]),
    yn("red_flag", "smoking_pack_years", "Smoking history", "How much smoking, for how many years (pack-years or beedis per day)?", ["smoker", "smoking", "beedi", "cigarette", "pack years", "packs", "per day", "hookah", "chillum", "ex smoker"]),
    yn("red_flag", "calf_pain_immobilisation", "Calf pain / immobilisation", "Any calf pain or swelling, recent surgery, or immobilisation (with haemoptysis)?", ["calf pain", "calf swelling", "immobilisation", "immobilization", "bed rest", "recent surgery", "long travel", "dvt"], { tier: "detailed" }),
    IMMUNOCOMPROMISE,
    // Exposures
