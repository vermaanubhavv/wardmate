...
export const abdominalPainV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "sudden_severe", "Sudden severe onset", "Did the pain begin suddenly and severely (as in perforation, rupture or ischaemia)?", ["sudden", "suddenly", "abrupt", "severe from the start", "thunderclap", "all of a sudden", "maximum at onset"]),
    yn("red_flag", "peritonism_symptoms", "Pain on movement / coughing", "Is the pain worse on movement, coughing, or bumps in the road (peritoneal irritation)?", ["worse on movement", "movement", "coughing", "jolt", "jerk", "bumps", "lying still", "cannot move", "guarding", "rigid"]),
    yn("red_flag", "bilious_faeculent_vomiting", "Bilious / faeculent vomiting", "Is the vomiting green (bilious) or foul (faeculent)?", ["bilious", "green vomit", "green", "faeculent", "feculent", "foul smelling vomit"]),
    yn("red_flag", "obstipation", "Absolute constipation", "Is the patient passing neither stool nor flatus?", ["not passing flatus", "not passed flatus", "no flatus", "obstipation", "absolute constipation", "not passing stool and flatus", "neither stool nor flatus"]),
    yn("red_flag", "syncope_giddiness", "Giddiness / fainting", "Any giddiness, fainting or cold sweats (bleeding or shock)?", ["giddiness", "giddy", "fainting", "fainted", "syncope", "collapse", "cold sweat", "sweating", "lightheaded"]),
    yn("red_flag", "cardiac_symptoms", "Chest symptoms with epigastric pain", "Any chest pain, breathlessness or sweating with the pain (inferior MI mimic)?", ["chest pain", "breathlessness", "breathless", "sweating", "palpitations", "exertion"]),
    yn("red_flag", "diabetic_symptoms", "Diabetes / polyuria / vomiting (DKA)", "Is the patient diabetic, with vomiting, thirst or excessive urination?", ["diabetic", "diabetes", "polyuria", "polydipsia", "thirst", "sugar", "insulin", "missed insulin"]),
