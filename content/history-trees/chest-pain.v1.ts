...
export const chestPainV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "breathlessness", "Breathlessness", "Any breathlessness with the pain?", ["breathlessness", "breathless", "shortness of breath", "dyspnoea", "dyspnea", "difficulty breathing", "difficulty in breathing", "sob"]),
    yn("red_flag", "syncope", "Syncope / giddiness", "Any fainting, near-fainting, or giddiness?", ["syncope", "fainted", "fainting", "blackout", "collapse", "giddiness", "giddy", "lightheaded", "dizziness", "dizzy", "unconscious"]),
    yn("red_flag", "tearing_to_back", "Tearing pain to the back", "Was the pain tearing or ripping in character, radiating to the back?", ["tearing", "ripping", "to the back", "interscapular", "between the shoulder blades"]),
    yn("red_flag", "neuro_deficit", "Focal neurological symptom", "Any weakness of a limb, slurred speech, or facial deviation with the pain?", ["weakness", "slurred speech", "slurring", "facial deviation", "deviation of face", "paralysis", "numbness", "hemiparesis"]),
    ...
    yn("red_flag", "cardiac_risk", "Cardiac risk factors", "Any diabetes, hypertension, smoking, dyslipidaemia, family history of early heart disease, or known heart disease?", ["diabetes", "diabetic", "hypertension", "hypertensive", "smoker", "smoking", "beedi", "cholesterol", "dyslipidaemia", "dyslipidemia", "family history", "heart attack", "heart disease", "ihd", "cad", "angioplasty", "stent", "bypass", "cabg"]),
    yn("red_flag", "cocaine_drugs", "Stimulant / drug use", "Any cocaine, amphetamine or other stimulant use?", ["cocaine", "amphetamine", "stimulant", "drug abuse", "drugs"], { tier: "detailed" }),
    yn("red_flag", "hypertension_uncontrolled", "Known / uncontrolled hypertension", "Is the patient hypertensive, and is it controlled?", ["hypertension", "hypertensive", "blood pressure", "bp", "uncontrolled"]),
    IMMUNOCOMPROMISE,
