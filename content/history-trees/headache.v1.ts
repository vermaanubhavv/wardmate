...
/**
 * HEADACHE — v1.0.0. CLINICAL CONTENT: PENDING CLINICIAN REVIEW.
...
export const headacheV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "thunderclap", "Thunderclap onset", "Did it reach maximum within seconds to a minute (thunderclap)?", ["thunderclap", "within seconds", "seconds", "instantly", "sudden severe", "like a blow", "worst headache", "hit on the head"]),
    yn("red_flag", "neck_stiffness", "Neck stiffness", "Any neck stiffness or pain on bending the neck?", ["neck stiffness", "stiff neck", "neck rigidity", "neck pain", "cannot bend neck"]),
    yn("red_flag", "altered_sensorium", "Altered sensorium / behaviour change", "Any drowsiness, confusion, irritability or behaviour change?", ["drowsy", "drowsiness", "confused", "confusion", "altered sensorium", "irritable", "behaviour change", "irrelevant talk", "disoriented", "unconscious"]),
    yn("red_flag", "seizure", "Seizure", "Any seizure or fit?", ["seizure", "seizures", "fit", "fits", "convulsion", "convulsions"]),
    yn("red_flag", "focal_deficit", "Focal weakness / speech / gait", "Any weakness of a limb, facial deviation, slurred speech, or unsteadiness?", ["weakness", "paralysis", "hemiparesis", "facial deviation", "slurred speech", "slurring", "unsteady", "imbalance", "ataxia", "numbness", "difficulty walking"]),
    yn("red_flag", "new_or_changed", "New pattern / changed headache", "Is this a new type of headache, or a change from the usual pattern?", ["new", "first time", "never before", "different from usual", "changed", "change in pattern", "new headache"]),
    yn("red_flag", "positional_pressure", "Postural / raised-pressure features", "Is it worse lying down, on coughing or straining, or does it wake the patient from sleep?", ["worse lying down", "lying down", "coughing", "straining", "wakes from sleep", "wakes up", "early morning", "projectile"]),
    yn("red_flag", "head_injury", "Recent head injury / anticoagulants", "Any head injury recently, or is the patient on blood thinners?", ["head injury", "trauma", "fall", "hit", "blood thinner", "anticoagulant", "warfarin", "aspirin", "clopidogrel"]),
    yn("red_flag", "hypertension", "Hypertension", "Is the patient hypertensive, and was a high reading recorded?", ["hypertension", "hypertensive", "blood pressure", "bp", "high bp", "raised bp"]),
    yn("red_flag", "age_over_50_new", "Age over 50 with new headache", "Is the patient over 50 with a new headache?", ["over 50", "elderly", "age", "50 years", "60 years", "new onset"], { tier: "detailed" }),
    PREGNANCY,
    IMMUNOCOMPROMISE,
    // Exposures
