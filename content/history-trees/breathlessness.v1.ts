...
/**
 * BREATHLESSNESS — v1.0.0. CLINICAL CONTENT: REVIEWED (Dr Anubhav Verma).
...
export const breathlessnessV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "rest_dyspnoea", "Breathless at rest / unable to speak", "Is the patient breathless at rest or unable to complete sentences?", ["at rest", "unable to speak", "cannot speak", "cannot complete sentences", "sentences", "gasping", "severe breathlessness"], { teach: "Breathlessness at rest, or unable to speak in sentences, marks the patient who needs oxygen and monitoring now, whatever the cause." }),
    yn("red_flag", "sudden_onset", "Sudden onset", "Did it begin suddenly, over minutes?", ["sudden", "suddenly", "abrupt", "over minutes", "all of a sudden"], { teach: "Breathlessness that began within minutes points to pneumothorax, pulmonary embolism, arrhythmia or acute pulmonary oedema rather than an infection or a chronic disease." }),
    yn("red_flag", "haemoptysis", "Haemoptysis", "Any blood in the sputum?", ["haemoptysis", "hemoptysis", "blood in sputum", "coughing blood", "blood in cough"], { teach: "Blood in the sputum with breathlessness raises embolism, tuberculosis, malignancy and pulmonary oedema." }),
    yn("red_flag", "syncope", "Syncope / giddiness", "Any fainting or giddiness?", ["syncope", "fainted", "fainting", "blackout", "collapse", "giddiness", "giddy", "dizziness"], { teach: "A blackout with breathlessness points to a massive embolism or an arrhythmia." }),
    yn("red_flag", "altered_sensorium", "Drowsiness / confusion", "Any drowsiness or confusion?", ["drowsy", "drowsiness", "confused", "confusion", "altered sensorium", "irritable", "disoriented"], { teach: "Drowsiness or confusion in a breathless patient is a sign of hypoxia or carbon dioxide retention and precedes respiratory arrest." }),
    yn("red_flag", "cyanosis_symptoms", "Bluish lips / nails", "Any bluish discolouration of lips or nails noticed?", ["bluish", "blue lips", "blue nails", "cyanosis", "cyanosed", "discolouration"], { teach: "Blue lips noticed by the family is a report of hypoxaemia that has already happened." }),
    yn("red_flag", "recent_immobilisation", "Recent immobilisation / surgery / calf pain", "Any recent surgery, bed rest, long travel, or calf pain or swelling?", ["immobilisation", "immobilization", "bed rest", "bedridden", "long travel", "long journey", "recent surgery", "operated", "calf pain", "calf swelling", "plaster", "dvt"], { teach: "Bed rest, a long journey, surgery or a plaster cast in the past month raises pulmonary embolism, which is otherwise easy to attribute to something else." }),
    yn("red_flag", "cardiac_history", "Known heart / lung / kidney disease", "Any known heart disease, hypertension, COPD, asthma, kidney disease or diabetes?", ["heart disease", "heart failure", "ihd", "cad", "hypertension", "copd", "asthma", "asthmatic", "kidney disease", "ckd", "dialysis", "diabetes", "diabetic", "valve", "rheumatic"], { teach: "A prior heart attack, valve disease or heart failure makes cardiac breathlessness the first thing to exclude." }),
    IMMUNOCOMPROMISE,
    PREGNANCY,
    // Exposures
