...
export const alteredSensoriumV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "neck_stiffness", "Neck stiffness", "Any neck stiffness or pain on bending the neck?", ["neck stiffness", "stiff neck", "neck rigidity", "neck pain"]),
    yn("red_flag", "head_injury", "Head injury / fall", "Any recent head injury or fall, even weeks ago?", ["head injury", "trauma", "fall", "fell", "hit", "accident", "rta"]),
    yn("red_flag", "poisoning", "Poisoning / overdose", "Any possibility of poisoning, insecticide, or overdose — empty containers, suicidal intent, smell?", ["poison", "poisoning", "insecticide", "organophosphate", "op poisoning", "overdose", "consumed", "ingested", "tablets consumed", "suicidal", "smell", "empty bottle", "celphos", "aluminium phosphide"]),
    yn("red_flag", "alcohol", "Alcohol use / recent cessation", "Does the patient drink alcohol, and when was the last drink?", ["alcohol", "alcoholic", "drinks", "drinking", "last drink", "stopped drinking", "withdrawal", "liquor", "daru"]),
    yn("red_flag", "diabetes_insulin", "Diabetes / insulin / sulfonylurea", "Is the patient diabetic, on insulin or sugar-lowering tablets, and when did they last eat?", ["diabetes", "diabetic", "insulin", "sugar tablets", "sugar medicine", "hypoglycaemia", "hypoglycemia", "sugar low", "not eaten", "skipped meals", "last meal"]),
    yn("red_flag", "hypertension", "Hypertension", "Is the patient hypertensive, and was a high reading recorded?", ["hypertension", "hypertensive", "blood pressure", "bp", "high bp"]),
    yn("red_flag", "known_epilepsy", "Known epilepsy / drug adherence", "Is the patient a known case of seizures, and have anti-seizure medicines been missed?", ["epilepsy", "epileptic", "known seizure", "seizure disorder", "on antiepileptic", "missed", "stopped medicine", "not taking", "compliance", "adherence"]),
    yn("red_flag", "kidney_liver_disease", "Known kidney / liver disease", "Any known kidney disease, liver disease, or dialysis?", ["kidney disease", "ckd", "renal failure", "dialysis", "liver disease", "cirrhosis", "cld", "hepatic"]),
    yn("red_flag", "focal_onset_or_first", "First seizure in adulthood / focal onset", "Is this the first-ever seizure in an adult, or did it start focally?", ["first seizure", "first time", "never before", "new onset", "focal", "one side", "started in"], { tier: "detailed" }),
    PREGNANCY,
    IMMUNOCOMPROMISE,
    // Exposures
