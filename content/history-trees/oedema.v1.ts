...
export const oedemaV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "urine_output", "Reduced urine output", "Has the urine output reduced markedly?", ["urine output", "decreased urine", "reduced urine", "less urine", "oliguria", "anuria", "not passing urine"]),
    yn("red_flag", "rest_dyspnoea", "Breathless at rest", "Is the patient breathless at rest?", ["at rest", "unable to speak", "gasping", "severe breathlessness"]),
    ...
    yn("red_flag", "chest_pain", "Chest pain", "Any chest pain?", ["chest pain", "pain in chest", "chest discomfort"]),
    yn("red_flag", "hypertension_diabetes", "Hypertension / diabetes / kidney disease", "Is the patient hypertensive, diabetic, or known to have kidney disease?", ["hypertension", "hypertensive", "blood pressure", "diabetes", "diabetic", "kidney disease", "ckd", "renal", "dialysis", "creatinine"]),
    yn("red_flag", "cardiac_history", "Known heart disease", "Any known heart disease, rheumatic fever, or prior heart attack?", ["heart disease", "heart failure", "rheumatic", "valve", "heart attack", "ihd", "cad", "cardiomyopathy"]),
    yn("red_flag", "drugs", "Drugs that cause oedema / kidney injury", "Any amlodipine, NSAIDs, steroids, or other new drugs?", ["amlodipine", "nifedipine", "nsaid", "painkillers", "steroid", "steroids", "pioglitazone", "drug history", "on medication", "new medicine"]),
    PREGNANCY,
    IMMUNOCOMPROMISE,
    // Exposures
