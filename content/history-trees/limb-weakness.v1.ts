...
/**
 * WEAKNESS OF LIMBS — v1.0.0. CLINICAL CONTENT: PENDING CLINICIAN REVIEW.
...
export const limbWeaknessV1: HistoryTree = {
  ...
  slots: [
    ...
    // Red flags
    yn("red_flag", "sudden_onset", "Sudden onset", "Did the weakness come on suddenly, over minutes?", ["sudden", "suddenly", "abrupt", "minutes", "woke up with", "on waking"]),
    yn("red_flag", "sensory_level_bladder", "Sensory level with bladder involvement", "Is there a level below which sensation is lost, along with bladder or bowel disturbance?", ["sensory level", "level", "below the", "band", "girdle", "retention", "incontinence", "catheter"]),
    yn("red_flag", "rapid_ascending", "Rapidly ascending weakness", "Is the weakness ascending from the legs and progressing over hours to days?", ["ascending", "progressing", "rapidly", "hours", "spreading up", "now arms", "climbing up"]),
    yn("red_flag", "respiratory_bulbar", "Breathing or swallowing involvement", "Is there any breathing difficulty, weak cough, or difficulty swallowing?", ["breathing difficulty", "breathless", "weak cough", "cannot cough", "swallowing", "choking", "nasal regurgitation", "single breath"]),
    yn("red_flag", "altered_sensorium", "Altered sensorium / seizure", "Any drowsiness, confusion, or seizure?", ["drowsy", "drowsiness", "confused", "confusion", "altered sensorium", "seizure", "fit", "convulsion", "unconscious"]),
    yn("red_flag", "hypertension_diabetes", "Hypertension / diabetes / heart disease", "Is the patient hypertensive, diabetic, or known to have heart disease or atrial fibrillation?", ["hypertension", "hypertensive", "diabetes", "diabetic", "heart disease", "atrial fibrillation", "af", "valve", "rheumatic", "stroke before"]),
    yn("red_flag", "trauma", "Trauma / fall", "Any fall or injury to the spine or head?", ["fall", "fell", "injury", "trauma", "accident", "rta", "lifting"]),
    yn("red_flag", "cancer_history", "Known malignancy", "Any known cancer, or symptoms suggestive of one?", ["cancer", "malignancy", "carcinoma", "tumour", "tumor", "lump", "chemotherapy"], { tier: "detailed" }),
    PREGNANCY,
    IMMUNOCOMPROMISE,
    // Exposures
